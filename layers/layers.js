...
var format_Arbres_remarquables_14 = new ol.format.GeoJSON();
var features_Arbres_remarquables_14 = format_Arbres_remarquables_14.readFeatures(json_Arbres_remarquables_14, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Arbres_remarquables_14 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Arbres_remarquables_14.addFeatures(features_Arbres_remarquables_14);
var lyr_Arbres_remarquables_14 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Arbres_remarquables_14, 
                style: style_Arbres_remarquables_14,
                popuplayertitle: 'Arbres_remarquables',
                interactive: false,
    title: 'Arbres_remarquables<br />\
    <img src="styles/legend/Arbres_remarquables_14_0.png" /> Conifères<br />\
    <img src="styles/legend/Arbres_remarquables_14_1.png" /> Feuillus<br />' });
var format_Hbergements_15 = new ol.format.GeoJSON();
var features_Hbergements_15 = format_Hbergements_15.readFeatures(json_Hbergements_15, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Hbergements_15 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Hbergements_15.addFeatures(features_Hbergements_15);
var lyr_Hbergements_15 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Hbergements_15, 
                style: style_Hbergements_15,
                popuplayertitle: 'Hébergements',
                interactive: false,
                title: '<img src="styles/legend/Hbergements_15.png" /> Hébergements'
            });
...
lyr_Route_d_acces_13.set('fieldAliases', {'fid': 'fid', 'gpkg_fid': 'gpkg_fid', 'felt:feature': 'felt:feature', 'felt:has_geometry': 'felt:has_geometry', 'felt:h3_index': 'felt:h3_index', 'felt:geometry_size': 'felt:geometry_size', 'Name': 'Name', 'Untitled': 'Untitled', 'Untitled 2': 'Untitled 2', 'Untitled 3': 'Untitled 3', 'Untitled 4': 'Untitled 4', 'Untitled 5': 'Untitled 5', 'Untitled 6': 'Untitled 6', 'Untitled 7': 'Untitled 7', 'Untitled 8': 'Untitled 8', 'Untitled 9': 'Untitled 9', 'Untitled 10': 'Untitled 10', 'Untitled 11': 'Untitled 11', });
lyr_Arbres_remarquables_14.set('fieldAliases', {'fid': 'fid', 'Nom_usuel': 'Nom_usuel', 'id_botanique_ref': 'id_botanique_ref', 'Age': 'Age', 'Circonférence': 'Circonférence', 'Hauteur': 'Hauteur', 'Nom_latin': 'Nom_latin', 'Type_botanique': 'Type_botanique', });
lyr_Hbergements_15.set('fieldAliases', {'fid': 'fid', 'nom_gite': 'nom_gite', });
...
lyr_Arbres_remarquables_14.set('fieldImages', {'fid': 'Hidden', 'Nom_usuel': 'TextEdit', 'id_botanique_ref': 'ValueRelation', 'Age': 'TextEdit', 'Circonférence': 'TextEdit', 'Hauteur': 'TextEdit', 'Nom_latin': 'TextEdit', 'Type_botanique': 'Range', });
lyr_Hbergements_15.set('fieldImages', {'fid': 'TextEdit', 'nom_gite': 'TextEdit', });
...
lyr_Route_d_acces_13.set('fieldLabels', {'fid': 'no label', 'gpkg_fid': 'no label', 'felt:feature': 'no label', 'felt:has_geometry': 'no label', 'felt:h3_index': 'no label', 'felt:geometry_size': 'no label', 'Name': 'no label', 'Untitled': 'no label', 'Untitled 2': 'no label', 'Untitled 3': 'no label', 'Untitled 4': 'no label', 'Untitled 5': 'no label', 'Untitled 6': 'no label', 'Untitled 7': 'no label', 'Untitled 8': 'no label', 'Untitled 9': 'no label', 'Untitled 10': 'no label', 'Untitled 11': 'no label', });
lyr_Arbres_remarquables_14.set('fieldLabels', {'Nom_usuel': 'no label', 'id_botanique_ref': 'no label', 'Age': 'no label', 'Circonférence': 'no label', 'Hauteur': 'no label', 'Nom_latin': 'no label', 'Type_botanique': 'no label', });
lyr_Hbergements_15.set('fieldLabels', {'fid': 'no label', 'nom_gite': 'no label', });
lyr_Hbergements_15.on('precompose', function(evt) {
