...
lyr_Hbergements_16.set('fieldAliases', {'fid': 'fid', 'nom_gite': 'nom_gite', 'Capacite': 'Capacite', 'Description': 'Description', 'Photo': 'Photo', 'Lien': 'Lien', });
...
lyr_Hbergements_16.set('fieldImages', {'fid': 'TextEdit', 'nom_gite': 'TextEdit', 'Capacite': 'Range', 'Description': 'TextEdit', 'Photo': 'ExternalResource', 'Lien': 'TextEdit', });
...
lyr_Hbergements_16.set('fieldLabels', {'fid': 'no label', 'nom_gite': 'header label - always visible', 'Capacite': 'no label', 'Description': 'no label', 'Photo': 'inline label - always visible', 'Lien': 'inline label - always visible', });
